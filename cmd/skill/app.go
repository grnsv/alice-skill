...
import (
	...
	"github.com/grnsv/alice-skill/internal/logger"
	"github.com/grnsv/alice-skill/internal/models"
	"github.com/grnsv/alice-skill/internal/store"
	"go.uber.org/zap"
)
...
func parseReadCommand(cmd string) int {
	return len(cmd)
}

func parseRegisterCommand(cmd string) string {
	return cmd
}
